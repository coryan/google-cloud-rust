...
pub mod secret {
    ...
    impl Expiration {
        ...
        pub fn from_expire_time(value: impl std::convert::Into<std::boxed::Box<wkt::Timestamp>>) -> Self {
...
pub mod replication {
    ...
    impl Replication {
        ...
        pub fn from_automatic(value: impl std::convert::Into<std::boxed::Box<crate::model::replication::Automatic>>) -> Self {
            Self::Automatic(value.into())
        }
        /// Initializes the enum to the [UserManaged](Self::UserManaged) branch.
        pub fn from_user_managed(value: impl std::convert::Into<std::boxed::Box<crate::model::replication::UserManaged>>) -> Self {
...
pub mod replication_status {
    ...
    impl ReplicationStatus {
        /// Initializes the enum to the [Automatic](Self::Automatic) branch.
        pub fn from_automatic(value: impl std::convert::Into<std::boxed::Box<crate::model::replication_status::AutomaticStatus>>) -> Self {
            Self::Automatic(value.into())
        }
        /// Initializes the enum to the [UserManaged](Self::UserManaged) branch.
        pub fn from_user_managed(value: impl std::convert::Into<std::boxed::Box<crate::model::replication_status::UserManagedStatus>>) -> Self {
            Self::UserManaged(value.into())
        }
    }
}
