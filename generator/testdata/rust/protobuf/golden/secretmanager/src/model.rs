...
impl Secret {
    ...
    /// Sets the value of [expiration] to hold a
...
impl Replication {
    ...
    /// Sets the value of [replication] to hold a
...
impl ReplicationStatus {
    ...
    pub fn get_automatic(&self) -> std::option::Option<&std::boxed::Box<crate::model::replication_status::AutomaticStatus>> {
        #[allow(unreachable_patterns)]
        self.replication_status.as_ref().map(|v| match v {
    ...
    /// Sets the value of [replication_status] to hold a
