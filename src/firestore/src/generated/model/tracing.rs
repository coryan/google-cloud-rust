...
/// Implements a [Firestore](crate::stubs::Firestore) decorator for logging and tracing.
#[derive(Clone, Debug)]
pub struct Firestore<T>
where T: crate::stubs::Firestore + std::fmt::Debug + Send + Sync {
    inner: T,
}
...
impl<T> crate::stubs::Firestore for Firestore<T>
where T: crate::stubs::Firestore + std::fmt::Debug + Send + Sync {
