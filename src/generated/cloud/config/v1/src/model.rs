...
pub mod deployment {
    ...
    impl Blueprint {
        /// Initializes the enum to the [TerraformBlueprint](Self::TerraformBlueprint) branch.
        pub fn from_terraform_blueprint(
            value: impl std::convert::Into<std::boxed::Box<crate::model::TerraformBlueprint>>,
        ) -> Self {
            Self::TerraformBlueprint(value.into())
        }
    }
}
...
pub mod terraform_blueprint {
    ...
    impl Source {
        ...
        pub fn from_gcs_source(value: impl std::convert::Into<std::string::String>) -> Self {
...
pub mod operation_metadata {
    ...
    impl ResourceMetadata {
        /// Initializes the enum to the [DeploymentMetadata](Self::DeploymentMetadata) branch.
        pub fn from_deployment_metadata(
            value: impl std::convert::Into<std::boxed::Box<crate::model::DeploymentOperationMetadata>>,
        ) -> Self {
            Self::DeploymentMetadata(value.into())
        }
        /// Initializes the enum to the [PreviewMetadata](Self::PreviewMetadata) branch.
        pub fn from_preview_metadata(
            value: impl std::convert::Into<std::boxed::Box<crate::model::PreviewOperationMetadata>>,
        ) -> Self {
            Self::PreviewMetadata(value.into())
        }
    }
}
