...
impl ConfigBuilder {
    ...
    /// Enable tracing.
    pub fn set_tracing(mut self) -> Self {
        self.tracing = true;
        self
    }
...
pub type SecretManagerService = Box<dyn client::SecretManagerService + Send + Sync>;
pub type Locations = Box<dyn client::Locations + Send + Sync>;
