...
where
    T: crate::client::SecretManagerService + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
impl<T> crate::client::SecretManagerService for SecretManagerService<T>
where
    T: crate::client::SecretManagerService + std::fmt::Debug + Send + Sync,
{
...
where
    T: crate::client::Locations + std::fmt::Debug + Send + Sync,
{
    inner: T,
}
...
#[async_trait::async_trait]
impl<T> crate::client::Locations for Locations<T>
where
    T: crate::client::Locations + std::fmt::Debug + Send + Sync,
{
