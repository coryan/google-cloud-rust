...
pub trait PollerExt<ResponseType, MetadatType> {
    fn with_options(self, options: PollerOptions) -> impl Poller<ResponseType, MetadatType>;
}
...
mod tests {
    use super::*;
    use crate::{BasePoller, PollingResult, sealed};
