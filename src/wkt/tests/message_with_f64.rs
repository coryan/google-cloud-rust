...
mod test {
    ...
    #[test_case(MessageWithF64::new(), r#"{"singular": null}"#)]
    #[test_case(MessageWithF64::new(), r#"{"optional": null}"#)]
    #[test_case(MessageWithF64::new(), r#"{"repeated": null}"#)]
    #[test_case(MessageWithF64::new(), r#"{"map": null}"#)]
    #[test_case(MessageWithF64::new().set_singular(1_f64),     r#"{"singular": null, "singular": 1}"#)]
    #[test_case(MessageWithF64::new().set_optional(0_f64),     r#"{"optional": null, "optional": 0}"#)]
    #[test_case(MessageWithF64::new().set_repeated([0_f64]),   r#"{"repeated": null, "repeated": [0]}"#)]
    #[test_case(MessageWithF64::new().set_map([("a", 0_f64)]), r#"{"map": null, "map": {"a": 0}}"#)]
    #[test_case(MessageWithF64::new().set_singular(1_f64),     r#"{"singular": null, "singular": 1, "singular": null}"#)]
    #[test_case(MessageWithF64::new().set_optional(0_f64),     r#"{"optional": null, "optional": 0, "optional": null}"#)]
    #[test_case(MessageWithF64::new().set_repeated([0_f64]),   r#"{"repeated": null, "repeated": [0], "repeated": null}"#)]
    #[test_case(MessageWithF64::new().set_map([("a", 0_f64)]), r#"{"map": null, "map": {"a": 0}, "map": null}"#)]
    fn null_values_have_no_effect(want: MessageWithF64, input: &str) -> Result {
