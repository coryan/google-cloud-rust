...
mod test {
    ...
    #[test_case(MessageWithU64::new(), r#"{"singular": null}"#)]
    #[test_case(MessageWithU64::new(), r#"{"optional": null}"#)]
    #[test_case(MessageWithU64::new(), r#"{"repeated": null}"#)]
    #[test_case(MessageWithU64::new(), r#"{"mapKey": null}"#)]
    #[test_case(MessageWithU64::new(), r#"{"mapValue": null}"#)]
    #[test_case(MessageWithU64::new(), r#"{"mapKeyValue": null}"#)]
    #[test_case(MessageWithU64::new().set_singular(1_u64),                 r#"{"singular": null, "singular": 1}"#)]
    #[test_case(MessageWithU64::new().set_optional(0_u64),                 r#"{"optional": null, "optional": 0}"#)]
    #[test_case(MessageWithU64::new().set_repeated([0_u64]),               r#"{"repeated": null, "repeated": [0]}"#)]
    #[test_case(MessageWithU64::new().set_map_key([(1_u64, "")]),          r#"{"mapKey": null, "mapKey": {"1": ""}}"#)]
    #[test_case(MessageWithU64::new().set_map_value([("a", 1_u64)]),       r#"{"mapValue": null, "mapValue": {"a": 1}}"#)]
    #[test_case(MessageWithU64::new().set_map_key_value([(1_u64, 0_u64)]), r#"{"mapKeyValue": null, "mapKeyValue": {"1": 0}}"#)]
    #[test_case(MessageWithU64::new().set_singular(1_u64),                 r#"{"singular": null, "singular": 1, "singular": null}"#)]
    #[test_case(MessageWithU64::new().set_optional(0_u64),                 r#"{"optional": null, "optional": 0, "optional": null}"#)]
    #[test_case(MessageWithU64::new().set_repeated([0_u64]),               r#"{"repeated": null, "repeated": [0], "repeated": null}"#)]
    #[test_case(MessageWithU64::new().set_map_key([(1_u64, "")]),          r#"{"mapKey": null, "mapKey": {"1": ""}, "mapKey": null}"#)]
    #[test_case(MessageWithU64::new().set_map_value([("a", 1_u64)]),       r#"{"mapValue": null, "mapValue": {"a": 1}, "mapValue": null}"#)]
    #[test_case(MessageWithU64::new().set_map_key_value([(1_u64, 0_u64)]), r#"{"mapKeyValue": null, "mapKeyValue": {"1": 0}, "mapKeyValue": null}"#)]
    fn null_values_have_no_effect(want: MessageWithU64, input: &str) -> Result {
    ...
    fn test_unknown(input: Value) -> Result {
        let deser = serde_json::from_value::<MessageWithU64>(input.clone())?;
